...
// 
//
// Related Topics 树 深度优先搜索 二叉搜索树 二叉树 👍 993 👎 0
...
public class Q0538ConvertBstToGreaterTree{
    public static void main(String[] args) {
         Solution solution = new Q0538ConvertBstToGreaterTree().new Solution();
    }
